...
module.exports = {
  ...
  security: {
     ...
     ***************************************************************************/
    cors: {
      allowOrigins: ["https://waves-africa-api.herokuapp.com"],
    },
  },
  ...
  session: {
    ...
    // url: process.env.REDISCLOUD_URL || 'redis://rediscloud:5nKMtGgVITXSfVEPLYy7P2RIoFnDYzri@redis-12267.c9.us-east-1-2.ec2.cloud.redislabs.com:12267',
